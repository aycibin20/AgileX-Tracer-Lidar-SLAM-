...
def merge_lidar_data():
    ...
    while not rospy.is_shutdown():
        ...
        merged_scan.angle_max = front_scan.angle_min + len(front_scan.ranges + rear_scan.ranges) * front_scan.angle_increment
        ...
        merged_scan.ranges = front_ranges + rear_ranges
        merged_scan.intensities = list(front_scan.intensities) + list(rear_scan.intensities[::-1])
